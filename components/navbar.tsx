        ...
        <div className="hidden md:flex md:space-x-8 md:items-center text-sm font-semibold tracking-wide">
          ...
          <div className="flex -space-x-3 ml-4">
            <a href="/userlogin"><button
              ...
              className={`border border-white px-4 py-2 rounded-md ${isHovered ? 'bg-rose-400' : 'hover:bg-secondary'}`}
            >
              LOGIN
            </button></a>
            <button
      ...
      >
        ...
        <div className="flex justify-between space-x-1 mt-6">
          <a href="/userlogin"><button
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
            className={`border border-white px-3 py-2 rounded-md ${isHovered ? 'bg-rose-400' : 'hover:bg-secondary'}`}
          >
            LOGIN
          </button></a>
          <button
